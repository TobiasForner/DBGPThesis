...
We analyse the competitive ratio of \crep{} with augmentation $(2+\epsilon)$ and show in \cref{comp_ratio_theo} that \crep{} is $O(2/\epsilon k\log k)$-competitive.
...
\begin{theo}
	...
	With augmentation $(2+\epsilon)$ the competitive ratio of \crep{} is in $O(2/\epsilon k \log k)$.
\end{theo}
...
We have shown that our algorithm \adjDel{} has a competitive ratio of $O(2/\epsilon k\log k)$ and we have presented our decomposition based approach to its implementation. 

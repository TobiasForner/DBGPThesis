...
private:
     ...
     */
    void moveSetsToCluster(const std::vector<unsigned int> &setIds, unsigned int clusterId, unsigned int targetSet);
     ...
     * @param clusterId id of the target cluster
     */
    void moveToCluster(unsigned int x, unsigned int clusterId);
